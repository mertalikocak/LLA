      ...
      <header className="primary-header flex align-items-center">
        ...
        <div className="navbar-wrapper flex">
          <nav className="flex nav">
            <ul
              data-visible="false"
              className="flex primary-nav align-items-center justify-content-center"
            >
              <li className="nav-list-item">
                <a
                  href="/#"
                  className="ff-nav fs-400 text-neutral-100 text-muted"
                >
                  Home
                </a>
              </li>
            ...
            <ul className="flex align-items-center primary-nav justify-content-end">
              ...
              <li className="nav-list-item">
                <a className="ff-nav fs-400 text-neutral-800 a-btn" href="/#">
                  Your Profile
                </a>
              </li>
            </ul>
