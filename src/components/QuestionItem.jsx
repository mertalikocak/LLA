...
function QuestionItem(props) {
  ...
  return (
    <div className="container bg-neutral-800 padding-b-3">
      <div className="q">
        <div className="flex padding-bt-2">
          <h1 className="ff-primary fs-600 text-neutral-100">
            {props.id + 1}.{" "}
          </h1>
          <h1 className="ff-primary fs-600 text-neutral-100 padding-left-1">
            {props.q}
          </h1>
        </div>
        <div className="">
          <button
            ...
            onClick={() => changeBorderColor(props.id * 4)}
          >
            {props.ans1}
          </button>
          <button
            className="default-color"
            onClick={() => changeBorderColor(props.id * 4 + 1)}
          >
            {props.ans2}
          </button>
          <button
            className="default-color"
            onClick={() => changeBorderColor(props.id * 4 + 2)}
          >
            {props.ans3}
          </button>
          <button
            className="default-color"
            onClick={() => changeBorderColor(props.id * 4 + 3)}
          >
            {props.ans4}
          </button>
        </div>
